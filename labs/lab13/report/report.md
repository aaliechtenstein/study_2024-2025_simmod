...
Report generated: Sat Apr  26 00:38:28 2025
...
В результате выполнения данной лабораторной работы было выполнено задание для самостоятельного выполнения: проведен анализ сети Петри, построена сеть в CPN Tools, построен граф состояний и проведен его анализ.
